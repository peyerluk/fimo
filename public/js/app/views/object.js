      ...
      loaded: function() {
        ...
        return $("#commentForm").submit(function(e) {
          fimo.data.post("objects/" + _this.instanceArguments['objectId'] + "/comment", {
            ...
            fimo.cache.remove("objects/" + _this.instanceArguments['objectId'] + "/show");
            fimo.cache.remove("jumbles/" + _this.instanceArguments['jumbleId'] + "/wall-by-users");
            return fimo.cache.remove("jumbles");
