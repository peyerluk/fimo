        ...
        return $("#commentForm").submit(function(e) {
          fimo.data.post("objects/" + _this.instanceArguments['objectId'] + "/comment", {
            ...
            _.each(data.comments, function(comment) {
              return commentsHtml = "" + commentsHtml + "<div class='well conversation-comment'><img src='" + comment.userImageUrl + "' width='30' height='30'><strong>" + comment.username + "</strong>:&nbsp;" + comment.text + "%></div><div class='clearfix'></div>";
            });
